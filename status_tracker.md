...
| WS12 | Epic 12 | Reliability/SRE/DR automation | SRE Team | In Progress | WS6 (runtime `/api/v1/sre/reliability/status` + `/api/v1/sre/rate-limit/check` starter contracts + WS12 smoke harness) |
