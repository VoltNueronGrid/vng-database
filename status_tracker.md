...
| H-03 | Control-plane resilience hardening | Distributed Systems | P0 | R2 | In Progress | Control-plane clustering requirement and SPOF closure criteria documented; chaos certification still pending |
| H-04 | Event durability hardening (outbox/replay) | Distributed Systems + SRE | P0 | R2 | In Progress | Outbox and replay durability controls defined in architecture; exactly-once/replay evidence still pending |
