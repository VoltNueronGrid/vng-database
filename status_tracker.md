...
| WS12 | Epic 12 | Reliability/SRE/DR automation | SRE Team | In Progress | WS6 (runtime SRE starter contracts: `/api/v1/sre/reliability/status`, `/api/v1/sre/rate-limit/check`, `/api/v1/sre/failure-budget/alerts`, `/api/v1/sre/dr/hooks/{trigger,status}` + WS12 smoke harness) |
