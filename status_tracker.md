...
| H-02 | In Progress | 40% | improving | P0 | R2 | Expanded H-02 with reorder/duplicate detection tests and artifact `tests/kpi/results/h02/htap-sync-reorder-duplicate-faults.json`, plus updated correctness spec | Distributed sync transport and restart semantics not yet implemented | Add restart continuity under distributed transport and replay semantics |
