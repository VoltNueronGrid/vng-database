...
| WS4 | Epic 4 | High-speed ingestion pipeline | Ingestion Team | In Progress | WS2 (ingestion connector/registry scaffold + ingest runtime endpoints enforce mixed operator-or-tenant RBAC; **Parquet + Excel** ingest via base64 JSON routes; `IngestParallelConfig` scaffold for REQ-07 in `batch_config.rs`; tenant-originated ingest audit path unchanged; parser smoke `tests/kpi/results/ws4/ws4-ingest-parser-smoke.json` (24 checks); gate `run-ws4-gate.ps1` -> `tests/kpi/results/ws4/ws4-gate-summary.json`; `.github/instructions/gate-scripts.instructions.md` documents base64 contract; workflow wiring in `.github/workflows/ci.yml`) |
...
| WS4 gate | passed | ready_for_validation | All packs passing. |
...
**Not-started requirements (0 total):** All requirements have active implementation. REQ-10/19 benchmark smoke script + artifact (2026-04-10). REQ-21: 7 ws21 tests as of 2026-04-11. REQ-23: 9 ws23 tests as of 2026-04-11. REQ-27: 11 ws27 tests as of 2026-04-11. REQ-07: async Tokio fan-out wired as of 2026-04-10. Total cargo test count: **157 passing** (149 + 5 ws0_* governance tests + 3 ws2a_* HTAP sync-origin tests added 2026-04-06).
