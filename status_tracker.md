...
| WS7 | Epic 7 | Plugin framework + connector plugin pack | Extensibility Team | In Progress | WS1, WS4A (signed manifest schema + checksum verification hook + validation-hook boundary + WS7 smoke harness) |
