...
exports.buildRemediationHint = buildRemediationHint;
/**
 ...
 */
function buildRemediationHint(endpoint, status, error, connection) {
    ...
    switch (status) {
        ...
        default: {
            ...
            const lowerError = (error ?? "").toLowerCase();
            if (lowerError.includes("refused") ||
...
//# sourceMappingURL=RemediationHints.js.map