param(
  [string]$OutputPath = "tests/kpi/results/ws4a/ws4a-gate-summary.json"
)
...
$packs = @(
  @{ Name = "ws4a-streaming-path"; Script = "tests/kpi/scripts/run-ws4a-streaming-smoke.ps1"; Artifact = "tests/kpi/results/ws4a/streaming-event-path-smoke.json" },
  @{ Name = "ws4a-replay-cursor"; Script = "tests/kpi/scripts/run-ws4a-replay-cursor-smoke.ps1"; Artifact = "tests/kpi/results/ws4a/replay-cursor-smoke.json" }
)
...
Write-Host "WS4A gate summary: $OutputPath ($status)"
