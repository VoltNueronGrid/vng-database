param(
  [string]$OutputPath = "tests/kpi/results/ws1a/ws1a-gate-summary.json"
)
...
$packs = @(
  @{
    Name = "ws1a-legacy-parity"
    Script = "tests/kpi/scripts/run-legacy-aggregation-parity.ps1"
    Artifact = "tests/kpi/results/parity/legacy-aggregation-parity.json"
  },
  @{
    Name = "ws1a-legacy-gap-report"
    Script = "tests/kpi/scripts/run-legacy-aggregation-gap-report.ps1"
    Artifact = "tests/kpi/results/parity/legacy-aggregation-gap-report.json"
  },
  @{
...
Write-Host "WS1A gate summary: $OutputPath ($status)"
