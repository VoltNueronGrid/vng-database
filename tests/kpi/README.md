...
- `scripts/run-ws12-reliability-smoke.ps1` - WS12 reliability/SRE baseline smoke (health + rate-limit + failure-budget burn alerting + DR hook policy gating/cooldown/retry-backoff contracts)
