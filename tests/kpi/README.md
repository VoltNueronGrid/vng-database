...
- `scripts/run-ws12-reliability-smoke.ps1` - WS12 reliability/SRE baseline smoke (health + rate-limit + failure-budget alerts + DR hook persistence/scheduler/policy/retry-plan + failure-signal + gate-evaluation contracts)
