...
pub fn builtin_function_catalog() -> Vec<RegisteredFunction> {
    ...
    vec![
        ...
        b!("ANY_VALUE",   true,  "Returns an arbitrary value from the group"),
        b!("APPROX_COUNT_DISTINCT", true, "Returns an approximate distinct-count estimate"),
        b!("LISTAGG",     false, "Concatenates ordered string values with a delimiter"),
        ...
        b!("IFNULL",      true,  "MySQL alias for COALESCE(x, y)"),
        b!("NVL",         true,  "Oracle alias for COALESCE(x, y)"),
        b!("NVL2",        true,  "Oracle conditional null-handling function"),
        b!("IFF",         true,  "Snowflake conditional function"),
        b!("DECODE",      true,  "Oracle conditional lookup function"),
        b!("ZEROIFNULL",  true,  "Returns zero when input is NULL"),
        b!("NULLIFZERO",  true,  "Returns NULL when input is zero"),
        // ── Date / time ───────────────────────────────────────────────────────
        ...
        b!("DATEDIFF",            true,  "Returns the difference between two date/time values"),
        b!("DATEADD",             true,  "Adds an interval to a date/time value"),
        ...
        b!("TO_CHAR",             true,  "Formats a value as text"),
        b!("TO_DATE",             true,  "Converts a string to a date"),
        b!("TO_TIMESTAMP",        true,  "Converts a string to a timestamp"),
        b!("TO_TIMESTAMP_NTZ",    true,  "Converts a string to a timestamp without time zone"),
        b!("TO_TIMESTAMP_TZ",     true,  "Converts a string to a timestamp with time zone"),
        b!("TO_NUMBER",           true,  "Converts a value to a numeric type"),
        b!("TO_VARCHAR",          true,  "Converts a value to a string"),
        // ── String ────────────────────────────────────────────────────────────
        ...
        b!("INSTR",    true, "Returns the position of a substring inside a string"),
        b!("POSITION",  true, "Returns the position of a substring inside a string"),
        b!("LENGTH",   true, "Returns the length of a string"),
        b!("CONCAT",   true, "Concatenates strings"),
        b!("CONCAT_WS", true, "Concatenates strings with a separator"),
        ...
        b!("REGEXP_SUBSTR",  true, "Extracts a substring using a regular expression"),
        b!("REGEXP_INSTR",   true, "Returns the position of a regex match"),
        b!("REGEXP_COUNT",   true, "Counts regex matches in a string"),
        // ── Type conversion ───────────────────────────────────────────────────
        ...
        b!("OBJECT_CONSTRUCT", true, "Constructs a Snowflake-style object"),
        b!("OBJECT_AGG",       false, "Aggregates key/value pairs into an object"),
        b!("ARRAY_CONSTRUCT",   true, "Constructs a Snowflake-style array"),
        b!("MAP_CONSTRUCT",     true, "Constructs a map from key/value arguments"),
        b!("ARRAY_TO_STRING",   true, "Concatenates array elements into a string"),
        b!("STRING_TO_ARRAY",   true, "Splits a string into an array"),
        // ── Window helpers ────────────────────────────────────────────────────
