...
#[derive(Debug, Serialize)]
struct RowsKeyEmptyCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalRecordActiveResponse {
    status: &'static str,
    active_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsKeyMinResponse {
    status: &'static str,
    has_key: bool,
    min_key: String,
}
...
#[derive(Debug, Serialize)]
struct WalMutationNonDeletedCountResponse {
    status: &'static str,
    non_deleted_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsValueEmptyCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalNonDeletedSpanResponse {
    status: &'static str,
    oldest_sequence: u64,
    newest_sequence: u64,
...
#[derive(Debug, Serialize)]
struct RowsValueNonEmptyCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalNonDeletedCountResponse {
    status: &'static str,
    non_deleted_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsKeyNonEmptyCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalNonDeletedLatestResponse {
    status: &'static str,
    latest_non_deleted_sequence: u64,
}

#[derive(Debug, Serialize)]
struct RowsValueNonBlankCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalNonDeletedOldestResponse {
    status: &'static str,
    oldest_non_deleted_sequence: u64,
}

#[derive(Debug, Serialize)]
struct RowsKeyNonBlankCountResponse {
    status: &'static str,
...
#[derive(Debug, Serialize)]
struct WalValueDistinctCountResponse {
    status: &'static str,
    distinct_value_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsValueDistinctCountResponse {
    status: &'static str,
    distinct_value_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalValueCaseVariantCountResponse {
    status: &'static str,
    case_variant_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsValueCaseVariantCountResponse {
    status: &'static str,
    case_variant_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalOrderByDescDirectionCountResponse {
    status: &'static str,
    desc_direction_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsOrderByDescDirectionCountResponse {
    status: &'static str,
    desc_direction_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalOrderByRandomSeededCountResponse {
    status: &'static str,
    random_seeded_order_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsOrderByRandomSeededCountResponse {
    status: &'static str,
    random_seeded_order_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalOrderByAscDirectionCountResponse {
    status: &'static str,
    asc_direction_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsOrderByAscDirectionCountResponse {
    status: &'static str,
    asc_direction_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalPaginationOffsetOnlyCountResponse {
    status: &'static str,
    offset_only_pagination_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsPaginationOffsetOnlyCountResponse {
    status: &'static str,
    offset_only_pagination_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalHavingWithoutGroupByCountResponse {
    status: &'static str,
    having_without_group_by_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsHavingWithoutGroupByCountResponse {
    status: &'static str,
    having_without_group_by_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalGroupByCubeCountResponse {
    status: &'static str,
    group_by_cube_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsGroupByCubeCountResponse {
    status: &'static str,
    group_by_cube_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalRightJoinCountResponse {
    status: &'static str,
    right_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsRightJoinCountResponse {
    status: &'static str,
    right_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalFullOuterJoinCountResponse {
    status: &'static str,
    full_outer_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsFullOuterJoinCountResponse {
    status: &'static str,
    full_outer_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalInnerJoinCountResponse {
    status: &'static str,
    inner_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsInnerJoinCountResponse {
    status: &'static str,
    inner_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalSemiJoinCountResponse {
    status: &'static str,
    semi_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsSemiJoinCountResponse {
    status: &'static str,
    semi_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalAntiJoinCountResponse {
    status: &'static str,
    anti_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsAntiJoinCountResponse {
    status: &'static str,
    anti_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalLeftSemiJoinCountResponse {
    status: &'static str,
    left_semi_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsLeftSemiJoinCountResponse {
    status: &'static str,
    left_semi_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalLeftAntiJoinCountResponse {
    status: &'static str,
    left_anti_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsLeftAntiJoinCountResponse {
    status: &'static str,
    left_anti_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalRightSemiJoinCountResponse {
    status: &'static str,
    right_semi_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsRightSemiJoinCountResponse {
    status: &'static str,
    right_semi_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalRightAntiJoinCountResponse {
    status: &'static str,
    right_anti_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsRightAntiJoinCountResponse {
    status: &'static str,
    right_anti_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalFullAntiJoinCountResponse {
    status: &'static str,
    full_anti_join_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsFullAntiJoinCountResponse {
    status: &'static str,
    full_anti_join_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalUnionAllCountResponse {
    status: &'static str,
    union_all_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsUnionAllCountResponse {
    status: &'static str,
    union_all_count: usize,
}
...
#[derive(Debug, Serialize)]
struct WalAggregateDistinctCountResponse {
    status: &'static str,
    aggregate_distinct_count: usize,
}

#[derive(Debug, Serialize)]
struct RowsAggregateDistinctCountResponse {
    status: &'static str,
    aggregate_distinct_count: usize,
}
...
async fn wal_mutation_non_deleted_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_value_empty_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_value_non_empty_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_non_deleted_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_key_non_empty_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_non_deleted_latest(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_value_non_blank_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_non_deleted_oldest(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_key_non_blank_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_value_distinct_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_value_distinct_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_value_case_variant_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_value_case_variant_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_order_by_desc_direction_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_order_by_desc_direction_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_order_by_random_seeded_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_order_by_random_seeded_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_order_by_asc_direction_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_order_by_asc_direction_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_pagination_offset_only_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_pagination_offset_only_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_having_without_group_by_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_having_without_group_by_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_group_by_cube_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_group_by_cube_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_right_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_full_outer_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_full_outer_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_inner_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_left_semi_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_left_semi_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_left_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_left_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_right_semi_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_right_semi_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_right_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_right_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_full_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_full_anti_join_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn wal_aggregate_distinct_count(
    State(state): State<AppState>,
    headers: HeaderMap,
...
async fn rows_aggregate_distinct_count(
    State(state): State<AppState>,
    headers: HeaderMap,
